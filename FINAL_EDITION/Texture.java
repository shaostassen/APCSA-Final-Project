...
{ //Texture class start 
	...
	public static Texture WOOD = new Texture("1.jfif", 64); //Creates a 64x64 texture that looks like wood
	public static Texture BRICK = new Texture("2.jfif", 64); //Creates a 64x64 texture that looks like bricks
	public static Texture BLUESTONE = new Texture("3.jfif", 64); //Creates a 64x64 texture that looks like blue stone
	public static Texture STONE = new Texture("4.jfif", 64); //Creates a 64x64 texture that looks like stone
