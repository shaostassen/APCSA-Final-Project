...
{ //Sprite texture start
	...
	public static SpriteTexture gold = new SpriteTexture("gold.jfif"); //Creates a sprite texture for the gold
	//There are three monsters to make an animation
	public static SpriteTexture monster1 = new SpriteTexture("monster1.jfif"); //Creates the first monster sprite which is both legs in front
	public static SpriteTexture monster2 = new SpriteTexture("monster2.jfif"); //Creates the second monster with the left leg in back and right in front
	public static SpriteTexture monster3 = new SpriteTexture("monster3.jfif"); //Creates the third monster with the right leg in back and the left in front
